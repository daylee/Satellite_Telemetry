...
We elicitate specifiations for communicating orbital data (Section \ref{orbitspec} and telemetry data (Section \ref{telemspec}) in turn. % We discuss multiple methods for validating our specifications and point out specific patterns that we observed during their development and testing.
%
...
The authors would like to thank Dr. James W. Cutler for providing data, as well as his experience and knowledge of CubeSat communications systems.
