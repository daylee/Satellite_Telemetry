...
In the typical design of a real CubeSat communications system, developers perform link budget calculations to determine several properties in their communications system. These calculations 
aid in understanding the gain and power requirements for the transmitting and receiving antennas of the system and are a primary factor in determining what kind of antenna is used to transmit data.
