...
\title{Formal Specification of Small Satellite Telemetry Variables}
...
%% Introduction
% Discuss CubeSat challenges.
% Importance of system health monitoring.
% Introduce formal methods.

%% Analysis
% Provide a generic description of CubeSat telemetry parameters.
% Talk about specifying parameters.
% Describe how data is collected from CubeSat, decoded, saved.
% Detail how we can run this through R2U2 to better understand performance.

%% Discussion
% Analysis of telemetry data can help us better monitor system health. Understand faults.
% During testing, can help diagnose potential problems and validate system performance.

%% Conclusion
% Formal methods are helpful for EVERYTHING
...
CubeSats are getting a lot of attention from many research communities due to their cheap price and easy accessibility to space \cite{cubesat101}.
%
Although a CubeSat offers the potential to replace large and complex satellites for various space missions, novel technology requires robust software performance.
% Need discussion.
This is difficult to implement for these small-scale missions and many failures (either partial or entire missions) have occurred \cite{alanazi2018, Improving2017}.
% 
All subsystems of a CubeSat are a combination of hardware and software components built on an embedded system, and so their design needs to consider characteristics such as real-time response, reactivity with other subsystems, minimized software with optimal data processing speeds, safety, reliability and nominal performance in the harsh environment of space.
%
All of these factors, coupled with CubeSat missions having relatively low budgets and fast turnaround times, increase the chances of CubeSat mission failure \cite{alanazi2018, Improving2017}.\\
% Why budget and fast turnabround make mission fail?

Issues with CubeSat missions take place at all stages, and are very broad in nature \cite{Improving2017}.
%
Flaws in design, workmanship, software, low reliability of hardware -- usually commercial off-the-shelf (COTS) -- components, lack of adequate testing and communications failures are among a few of the many problems experienced with building CubeSats, as is the case for larger satellites \cite{Improving2017}.
%
Even in decent shape, CubeSats can still experience faults, memory leaks, bad data collections, and other issues inherent with embedded systems. For this reason, collecting telemetry from any spacecraft is a necessity.
%
...
% Let's think about the title of the second section.
%%%%%%%%%%%%%%%%%%%%%
\section{Development of CubeSat Telemetry Example}
%%%%%%%%%%%%%%%%%%%%%
% We will describte how we preprare our test data.

We first consider information comprising typical CubeSat telemetry parameters. 

%%%%%%%%%%%%%%%%%%%%%
\section{Formal Specification and Logic Statements}
%%%%%%%%%%%%%%%%%%%%%



%%%%%%%%%%%%%%%%%%%%%
\section{System Health Monitoring Using R2U2}
%%%%%%%%%%%%%%%%%%%%%
