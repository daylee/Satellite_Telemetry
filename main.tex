...
The radio communications portion of the model uses a USRP B210 SDR from Ettus Research to transmit and receive sample telemetry data, as if a CubeSat were transmitting to the ground station. Telemetry is broadcasted to the receiving antenna when the communication status, shown in the the first dataplot of Figure \ref{OrbitalDatasets}, is active. The transmission takes place specifically at each time step where the communication status goes from inactive to active.
