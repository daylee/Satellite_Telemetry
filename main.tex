...
Motivated by the large number of CubeSat communications failures, in this project we propose to apply formal specification and runtime verification to a %real, full-scale 
