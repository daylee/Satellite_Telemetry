...
We created, tested and evaluated a model of a CubeSat communications system for the work described in this case study. This model was created using Matlab and Simulink as well as a software-defined radio (SDR). In the subsections below, we discuss the two major components of this model in-depth.
